...
|---|---|---|---|---|---|
| [COUNT](SQL Object Summary/COUNT.md) | Aggregate function | Count rows or non-null values | Column expression or `*` | Integer count per group | Query aggregation phase |
| [SUM](SQL Object Summary/SUM.md) | Aggregate function | Sum of numeric values | Numeric column or expression | Numeric sum per group | Query aggregation phase |
| [AVG](SQL Object Summary/AVG.md) | Aggregate function | Average of numeric values | Numeric column or expression | Numeric average per group | Query aggregation phase |
| [MIN / MAX](SQL Object Summary/MIN  MAX.md) | Aggregate function | Minimum/maximum value | Column of any comparable type | Extreme value per group | Query aggregation phase |
| [STDDEV / STDDEV_SAMP / STDDEV_POP](SQL Object Summary/STDDEV  STDDEV_SAMP  STDDEV_POP.md) | Aggregate function | Standard deviation | Numeric column or expression | Float standard deviation per group | Query aggregation phase |
| [VARIANCE / VAR_SAMP / VAR_POP](SQL Object Summary/VARIANCE  VAR_SAMP  VAR_POP.md) | Aggregate function | Variance | Numeric column or expression | Float variance per group | Query aggregation phase |
| [COVAR_SAMP / COVAR_POP](SQL Object Summary/COVAR_SAMP  COVAR_POP.md) | Aggregate function | Covariance | Two numeric expressions | Float covariance per group | Query aggregation phase |
| [CORR](SQL Object Summary/CORR.md) | Aggregate function | Correlation coefficient | Two numeric expressions | Float correlation per group | Query aggregation phase |
| [REGR_ functions](SQL Object Summary/REGR_ functions.md) | Aggregate function | Linear regression statistics | Two numeric expressions (y, x) | Regression metric per group | Query aggregation phase |
| [LISTAGG](SQL Object Summary/LISTAGG.md) | Aggregate function | String concatenation | String column or expression | Concatenated string per group | Query aggregation phase |
| [ARRAY_AGG](SQL Object Summary/ARRAY_AGG.md) | Aggregate function | Array collection | Column of any type | ARRAY per group | Query aggregation phase |
| [OBJECT_AGG](SQL Object Summary/OBJECT_AGG.md) | Aggregate function | Object collection | Key and value columns | OBJECT per group | Query aggregation phase |
| [BOOLAND_AGG / BOOLOR_AGG / BOOLXOR_AGG](SQL Object Summary/BOOLAND_AGG  BOOLOR_AGG  BOOLXOR_AGG.md) | Aggregate function | Boolean aggregation | Boolean expression | Boolean result per group | Query aggregation phase |
| [BITAND_AGG / BITOR_AGG / BITXOR_AGG](SQL Object Summary/BITAND_AGG  BITOR_AGG  BITXOR_AGG.md) | Aggregate function | Bitwise aggregation | Integer expression | Integer result per group | Query aggregation phase |
| [APPROX_COUNT_DISTINCT](SQL Object Summary/APPROX_COUNT_DISTINCT.md) | Aggregate function | Approximate distinct count | Column expression | Integer approximate count per group | Query aggregation phase |
| [APPROX_PERCENTILE](SQL Object Summary/APPROX_PERCENTILE.md) | Aggregate function | Approximate percentile | Numeric expression + percentile | Numeric approximate percentile per group | Query aggregation phase |
| [GROUP BY](SQL Object Summary/GROUP BY.md) | Clause | Define aggregation groups | Column expressions | One output row per group | Query grouping phase |
| [GROUP BY ALL](SQL Object Summary/GROUP BY ALL.md) | Clause | Automatic grouping | All non-aggregate SELECT columns | One output row per distinct combination | Query grouping phase |
| [CUBE / ROLLUP / GROUPING SETS](SQL Object Summary/CUBE  ROLLUP  GROUPING SETS.md) | Clause | Multi-dimensional grouping | Column list | Multiple grouping levels in one scan | Query grouping phase |
| [HAVING](SQL Object Summary/HAVING.md) | Clause | Post-aggregation filter | Boolean expression with aggregates | Filtered group result set | Query filtering phase |
| [DISTINCT](SQL Object Summary/DISTINCT.md) | Keyword | Deduplicate inputs | Column expression | Aggregate over unique values | Query aggregation phase |
...
|---|---|---|---|
| [Grouping key columns](Query Result Set (Aggregated)/Grouping key columns.md) | Dimensions | One per group | From `GROUP BY` |
| [Aggregate result columns](Query Result Set (Aggregated)/Aggregate result columns.md) | Metrics | One per group | From aggregate functions |
| [`GROUPING_ID`](Parameters  Variables  Configuration/GROUPING_ID.md) | Metadata | One per group | Bitmask of grouping levels (for CUBE/ROLLUP) |
...
|---|---|---|---|---|
| [`COUNT(*)`](Aggregate Function Signatures (Selected)/COUNT().md) | Any | NUMBER | Counts all rows | N/A |
| [`COUNT(expr)`](Aggregate Function Signatures (Selected)/COUNT(expr).md) | Any | NUMBER | Ignores nulls | Yes |
| [`SUM(expr)`](Aggregate Function Signatures (Selected)/SUM(expr).md) | Numeric | Numeric | Ignores nulls | Yes |
| [`AVG(expr)`](Aggregate Function Signatures (Selected)/AVG(expr).md) | Numeric | Numeric (float) | Ignores nulls | Yes |
| [`MIN(expr)` / `MAX(expr)`](Aggregate Function Signatures (Selected)/MIN(expr)  MAX(expr).md) | Comparable | Same as input | Ignores nulls | Yes |
| [`STDDEV_SAMP(expr)`](Aggregate Function Signatures (Selected)/STDDEV_SAMP(expr).md) | Numeric | FLOAT | Ignores nulls | No |
| [`STDDEV_POP(expr)`](Aggregate Function Signatures (Selected)/STDDEV_POP(expr).md) | Numeric | FLOAT | Ignores nulls | No |
| [`VAR_SAMP(expr)`](Aggregate Function Signatures (Selected)/VAR_SAMP(expr).md) | Numeric | FLOAT | Ignores nulls | No |
| [`VAR_POP(expr)`](Aggregate Function Signatures (Selected)/VAR_POP(expr).md) | Numeric | FLOAT | Ignores nulls | No |
| [`COVAR_SAMP(y, x)`](Aggregate Function Signatures (Selected)/COVAR_SAMP(y, x).md) | Numeric | FLOAT | Pairwise null handling | No |
| [`CORR(y, x)`](Aggregate Function Signatures (Selected)/CORR(y, x).md) | Numeric | FLOAT | Pairwise null handling | No |
| [`LISTAGG(expr, delimiter)`](Aggregate Function Signatures (Selected)/LISTAGG(expr, delimiter).md) | String | VARCHAR | Ignores nulls | No |
| [`ARRAY_AGG(expr)`](Aggregate Function Signatures (Selected)/ARRAY_AGG(expr).md) | Any | ARRAY | Includes nulls | No |
| [`OBJECT_AGG(key, value)`](Aggregate Function Signatures (Selected)/OBJECT_AGG(key, value).md) | String, Any | OBJECT | Includes nulls | No |
| [`APPROX_COUNT_DISTINCT(expr)`](Aggregate Function Signatures (Selected)/APPROX_COUNT_DISTINCT(expr).md) | Any | NUMBER | Ignores nulls | N/A (inherently distinct) |
| [`APPROX_PERCENTILE(expr, percentile)`](Aggregate Function Signatures (Selected)/APPROX_PERCENTILE(expr, percentile).md) | Numeric | Numeric | Ignores nulls | N/A |
...
|---|---|---|---|---|---|---|
| [`GROUP BY ALL`](Parameters  Variables  Configuration/GROUP BY ALL.md) | SQL clause | Automatic grouping | Implicit | None | `SELECT` | Groups by all non-aggregate columns |
| [`DISTINCT`](Parameters  Variables  Configuration/DISTINCT.md) | Keyword | Deduplication | `DISTINCT` | None (all values) | Aggregate function | Removes duplicates before aggregation |
| [`WITHIN GROUP (ORDER BY ...)`](Parameters  Variables  Configuration/WITHIN GROUP (ORDER BY ...).md) | Clause | Ordering | Sort expression | None | `LISTAGG`, `ARRAY_AGG` | Defines output element order |
| [`ON OVERFLOW`](Parameters  Variables  Configuration/ON OVERFLOW.md) | LISTAGG option | Truncation handling | `ERROR`, `TRUNCATE [delimiter]` | `ERROR` | `LISTAGG` | Behavior when result exceeds limit |
| [`CUBE`](Parameters  Variables  Configuration/CUBE.md) | Grouping operator | Multi-dimensional | Column list | None | `GROUP BY` | All combinations |
| [`ROLLUP`](Parameters  Variables  Configuration/ROLLUP.md) | Grouping operator | Hierarchical | Column list | None | `GROUP BY` | Hierarchical subtotals |
| [`GROUPING SETS`](Parameters  Variables  Configuration/GROUPING SETS.md) | Grouping operator | Explicit combinations | Column list tuples | None | `GROUP BY` | Custom grouping levels |
| [`GROUPING_ID`](Parameters  Variables  Configuration/GROUPING_ID.md) | Function | Grouping level mask | Column list | None | `SELECT` | Identifies active grouping columns |
| [`APPROXIMATE`](Parameters  Variables  Configuration/APPROXIMATE.md) | Keyword | Approximate mode | `APPROXIMATE` | Exact | `COUNT DISTINCT` | Enables HyperLogLog for distinct count |
| [`TIMEZONE`](Parameters  Variables  Configuration/TIMEZONE.md) | Session parameter | Temporal context | IANA timezone | `UTC` | Session | Affects date grouping and ordering |
...
|---|---|---|
| [Query aggregates](Privilege Requirements/Query aggregates.md) | `SELECT` on table | Table |
| [Use UDAFs](Privilege Requirements/Use UDAFs.md) | `USAGE` on function | Function |
| [Reference objects in aggregates](Privilege Requirements/Reference objects in aggregates.md) | `SELECT` on referenced objects | Tables/Views |
