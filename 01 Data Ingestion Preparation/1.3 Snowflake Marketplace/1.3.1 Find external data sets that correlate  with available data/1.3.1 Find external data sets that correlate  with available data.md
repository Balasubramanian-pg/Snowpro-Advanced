...
| :--- | :--- | :--- | :--- | :--- |
| [**Standard Listing**](Feature Summary/Standard Listing.md) | Data Product | Instant access to free or open datasets for enrichment. | Secure Data Sharing | Inbound Share -> Read-only Database |
| [**Personalized Listing**](Feature Summary/Personalized Listing.md) | Data Product | Requested access for customized, premium, or account-specific datasets. | Secure Data Sharing | Inbound Share -> Read-only Database |
| [**Data Correlation**](Feature Summary/Data Correlation.md) | SQL Pattern | Joining external shared data with internal tables. | standard `JOIN` execution | Unified result set combining internal and external fields |
