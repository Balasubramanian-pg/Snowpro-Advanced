...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [`DIRECTORY TABLE`](SQL Object Summary/DIRECTORY TABLE.md) | Implicit View | Provides a queryable catalog of file metadata on a stage. | Stage | Relational metadata set | Ad-hoc / Auto-refresh |
| [`GET_PRESIGNED_URL`](SQL Object Summary/GET_PRESIGNED_URL.md) | System Function | Generates a time-limited, externally accessible URL. | Stage Name, File Path | Expiring URL string | Ad-hoc |
| [`BUILD_SCOPED_FILE_URL`](SQL Object Summary/BUILD_SCOPED_FILE_URL.md)| System Function | Generates a temporary URL valid only for the active query/session. | Stage Name, File Path | Scoped URL string | Query Runtime |
| [`BUILD_STAGE_FILE_URL`](SQL Object Summary/BUILD_STAGE_FILE_URL.md) | System Function | Generates a permanent REST API URL requiring Snowflake authentication. | Stage Name, File Path | Permanent URL string | Ad-hoc |
| [`SnowflakeFile`](SQL Object Summary/SnowflakeFile.md) | Snowpark API | Allows Python/Java/Scala compute to dynamically open and read staged files. | Stage URL | File stream / bytes | Procedural |
...
| :--- | :--- | :--- |
| [`RELATIVE_PATH`](Data Model/RELATIVE_PATH.md) | VARCHAR | The path to the file relative to the stage root. |
| [`SIZE`](Data Model/SIZE.md) | NUMBER | Size of the file in bytes. |
| [`LAST_MODIFIED`](Data Model/LAST_MODIFIED.md) | TIMESTAMP_LTZ | The timestamp when the file was created or last updated. |
| [`MD5`](Data Model/MD5.md) | VARCHAR | The MD5 checksum of the file. |
| [`FILE_URL`](Data Model/FILE_URL.md) | VARCHAR | A pre-generated Stage File URL for immediate authenticated access. |
...
| :--- | :--- | :--- | :--- |
| [`DIRECTORY = (ENABLE = TRUE)`](Parameters  Configuration/DIRECTORY = (ENABLE = TRUE).md) | Boolean | `FALSE` | Must be set on the `STAGE` to activate directory table metadata tracking. |
| [`AUTO_REFRESH`](Parameters  Configuration/AUTO_REFRESH.md) | Boolean | `FALSE` | Configures the directory table to listen to cloud storage event notifications (e.g., SQS, Event Grid). |
| [`EXPIRATION_TIME`](Parameters  Configuration/EXPIRATION_TIME.md) | Integer | `3600` | Used in `GET_PRESIGNED_URL`. Defines the valid lifespan of the URL in seconds. |
