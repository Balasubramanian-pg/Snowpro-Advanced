...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [`COPY INTO <table>`](SQL Object Summary/COPY INTO table.md) | DML Command | Bulk loads CSV data into a target table. | Internal/External Stage | Populated Table | Batch / Micro-batch |
| [`SELECT FROM @stage`](SQL Object Summary/SELECT FROM @stage.md) | DQL Command | Queries CSV data directly without loading. | Internal/External Stage | Result Set | Ad-hoc / Interactive |
| [`FILE FORMAT`](SQL Object Summary/FILE FORMAT.md) | Schema Object | Defines parsing rules for the CSV engine. | Configuration parameters | Parsing configuration | Referenced at runtime |
| [`STAGE`](SQL Object Summary/STAGE.md) | Schema Object | Acts as a pointer to physical cloud storage. | S3, GCS, Azure Blob, Local | Virtual Directory | Referenced at runtime |
...
| :--- | :--- | :--- | :--- |
| [`TYPE`](Parameters  Configuration/TYPE.md) | String | `CSV` | Defines the file format engine. |
| [`COMPRESSION`](Parameters  Configuration/COMPRESSION.md) | String | `AUTO` | Automatically detects GZIP, BZ2, BROTLI, ZSTD, DEFLATE, RAW_DEFLATE. |
| [`RECORD_DELIMITER`](Parameters  Configuration/RECORD_DELIMITER.md) | String | `\n` (Newline) | Character separating rows. |
| [`FIELD_DELIMITER`](Parameters  Configuration/FIELD_DELIMITER.md) | String | `,` (Comma) | Character separating columns. |
| [`SKIP_HEADER`](Parameters  Configuration/SKIP_HEADER.md) | Integer | `0` | Number of header lines to skip before parsing data. |
| [`FIELD_OPTIONALLY_ENCLOSED_BY`](Parameters  Configuration/FIELD_OPTIONALLY_ENCLOSED_BY.md)| String | `NONE` | Character used to enclose strings (e.g., `"`), allowing delimiters inside strings. |
| [`NULL_IF`](Parameters  Configuration/NULL_IF.md) | Array | `['\\N']` | Array of strings to translate to SQL NULL. |
| [`ERROR_ON_COLUMN_COUNT_MISMATCH`](Parameters  Configuration/ERROR_ON_COLUMN_COUNT_MISMATCH.md)| Boolean| `TRUE` | Aborts if CSV columns do not match target table columns (or `SELECT` projection). |
| [`TRIM_SPACE`](Parameters  Configuration/TRIM_SPACE.md) | Boolean | `FALSE` | Removes leading and trailing whitespace from strings. |
