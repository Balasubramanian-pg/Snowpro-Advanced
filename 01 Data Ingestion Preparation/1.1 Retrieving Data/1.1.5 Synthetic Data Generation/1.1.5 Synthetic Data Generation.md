...
| :--- | :--- | :--- | :--- | :--- | :--- |
| [`GENERATOR`](SQL Object Summary/GENERATOR.md) | Table Function | Creates a specified number of empty rows to act as a multiplier. | `ROWCOUNT` or `TIMELIMIT` | Virtual rows | Compute runtime |
| [`SEQ1` to `SEQ8`](SQL Object Summary/SEQ1 to SEQ8.md) | System Function | Generates unique (but not gapless) auto-incrementing integers. | None | Integer | Compute runtime |
| [`RANDOM`](SQL Object Summary/RANDOM.md) | System Function | Generates a 64-bit pseudo-random integer. | Optional Seed | Integer | Compute runtime |
| [`UNIFORM`](SQL Object Summary/UNIFORM.md) | System Function | Generates a random number uniformly distributed within a specified range. | Min, Max, Random Generator | Integer / Float | Compute runtime |
| [`NORMAL` / `ZIPF`](SQL Object Summary/NORMAL  ZIPF.md) | System Function | Generates random numbers matching a specific statistical distribution. | Mean/Stdev, Random Generator | Float / Integer | Compute runtime |
...
| :--- | :--- | :--- | :--- |
| [`ROWCOUNT`](Parameters  Configuration/ROWCOUNT.md) | Integer | > 0 | Generates exactly this many rows. |
| [`TIMELIMIT`](Parameters  Configuration/TIMELIMIT.md) | Integer | > 0 | Generates as many rows as possible within this time limit (in seconds). |
| [`Seed`](Parameters  Configuration/Seed.md) | Integer | Any valid integer | An optional argument passed to `RANDOM(seed)` to guarantee the same pseudo-random output across executions for reproducibility. |
