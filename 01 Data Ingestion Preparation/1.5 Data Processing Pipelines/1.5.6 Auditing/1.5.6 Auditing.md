...
|---|---|---|---|---|---|
| [ACCOUNT_USAGE.QUERY_HISTORY](SQL Object Summary/ACCOUNT_USAGE.QUERY_HISTORY.md) | Account view | SQL execution audit | Query engine | Query text, user, role, timing, status, bytes | Query-time, 45-min latency |
| [ACCOUNT_USAGE.LOGIN_HISTORY](SQL Object Summary/ACCOUNT_USAGE.LOGIN_HISTORY.md) | Account view | Authentication audit | Identity layer | User, IP, status, timestamp, auth method | Query-time, 45-min latency |
| [ACCOUNT_USAGE.ACCESS_HISTORY](SQL Object Summary/ACCOUNT_USAGE.ACCESS_HISTORY.md) | Account view | Column/table access audit | Query execution | Columns accessed, tables referenced, query ID | Query-time, 45-min latency |
| [ACCOUNT_USAGE.WAREHOUSE_METERING_HISTORY](SQL Object Summary/ACCOUNT_USAGE.WAREHOUSE_METERING_HISTORY.md) | Account view | Compute consumption audit | Warehouse usage | Credits, time intervals, warehouse | Query-time, 45-min latency |
| [ACCOUNT_USAGE.COPY_HISTORY](SQL Object Summary/ACCOUNT_USAGE.COPY_HISTORY.md) | Account view | Load operation audit | COPY and Pipe operations | File names, rows loaded, errors | Query-time, 45-min latency |
| [ACCOUNT_USAGE.PIPE_USAGE_HISTORY](SQL Object Summary/ACCOUNT_USAGE.PIPE_USAGE_HISTORY.md) | Account view | Snowpipe operation audit | Pipe serverless compute | Files processed, credits, status | Query-time, 45-min latency |
| [ACCOUNT_USAGE.TASK_HISTORY](SQL Object Summary/ACCOUNT_USAGE.TASK_HISTORY.md) | Account view | Task execution audit | Task scheduler | State, error code, timing, query ID | Query-time, 45-min latency |
| [INFORMATION_SCHEMA.QUERY_HISTORY](SQL Object Summary/INFORMATION_SCHEMA.QUERY_HISTORY.md) | System view | Near-real-time query audit | Query engine | Same as account view, shorter retention | Query-time, near real-time |
| [INFORMATION_SCHEMA.LOGIN_HISTORY](SQL Object Summary/INFORMATION_SCHEMA.LOGIN_HISTORY.md) | System view | Near-real-time auth audit | Identity layer | Same as account view, shorter retention | Query-time, near real-time |
| [INFORMATION_SCHEMA.TABLE_STORAGE_METRICS](SQL Object Summary/INFORMATION_SCHEMA.TABLE_STORAGE_METRICS.md) | System view | Storage audit | Table metadata | Bytes, rows, clustering info | Query-time |
| [QUERY_TAG](SQL Object Summary/QUERY_TAG.md) | Session parameter | Execution traceability | User-defined metadata | Tagged audit records | Per-session or per-query |
| [AUDIT_LOG](SQL Object Summary/AUDIT_LOG.md) | External integration | Export to SIEM/storage | Internal audit events | Files in external stage | Automatic, continuous |
...
|---|---|---|---|
| [`QUERY_ID`](ACCOUNT_USAGE.ACCESS_HISTORY/QUERY_ID.md) | Primary identifier | One per query | UUID |
| [`QUERY_TEXT`](ACCOUNT_USAGE.QUERY_HISTORY/QUERY_TEXT.md) | Execution detail | One per query | Truncated at 10,000 characters |
| [`DATABASE_NAME`](ACCOUNT_USAGE.QUERY_HISTORY/DATABASE_NAME.md) | Context | One per query | |
| [`SCHEMA_NAME`](ACCOUNT_USAGE.QUERY_HISTORY/SCHEMA_NAME.md) | Context | One per query | |
| [`QUERY_TYPE`](ACCOUNT_USAGE.QUERY_HISTORY/QUERY_TYPE.md) | Classification | One per query | `SELECT`, `INSERT`, `CREATE`, etc. |
| [`SESSION_ID`](ACCOUNT_USAGE.QUERY_HISTORY/SESSION_ID.md) | Session trace | One per query | Links to login session |
...
| [`ERROR_CODE`](ACCOUNT_USAGE.LOGIN_HISTORY/ERROR_CODE.md) | Failure classification | One per failed query | |
| [`ERROR_MESSAGE`](ACCOUNT_USAGE.LOGIN_HISTORY/ERROR_MESSAGE.md) | Failure detail | One per failed query | |
...
| [`BYTES_SCANNED`](ACCOUNT_USAGE.QUERY_HISTORY/BYTES_SCANNED.md) | Data volume | One per query | |
...
| Column | Role | Grain | Notes |
|---|---|---|---|
| [`EVENT_ID`](ACCOUNT_USAGE.LOGIN_HISTORY/EVENT_ID.md) | Primary identifier | One per event | |
| [`EVENT_TIMESTAMP`](ACCOUNT_USAGE.LOGIN_HISTORY/EVENT_TIMESTAMP.md) | Timing | One per event | |
| [`EVENT_TYPE`](ACCOUNT_USAGE.LOGIN_HISTORY/EVENT_TYPE.md) | Classification | One per event | `LOGIN`, `LOGOUT` |
| [`USER_NAME`](ACCOUNT_USAGE.ACCESS_HISTORY/USER_NAME.md) | Identity | One per event | |
| [`CLIENT_IP`](ACCOUNT_USAGE.LOGIN_HISTORY/CLIENT_IP.md) | Source | One per event | May be proxy/VPN address |
| [`REPORTED_CLIENT_TYPE`](ACCOUNT_USAGE.LOGIN_HISTORY/REPORTED_CLIENT_TYPE.md) | Client info | One per event | `SNOWSQL`, `UI`, `JDBC`, etc. |
| [`IS_SUCCESS`](ACCOUNT_USAGE.LOGIN_HISTORY/IS_SUCCESS.md) | Outcome | One per event | `YES` or `NO` |
| [`ERROR_CODE`](ACCOUNT_USAGE.LOGIN_HISTORY/ERROR_CODE.md) | Failure code | One per failed event | |
| [`ERROR_MESSAGE`](ACCOUNT_USAGE.LOGIN_HISTORY/ERROR_MESSAGE.md) | Failure detail | One per failed event | |
| [`AUTHENTICATION_METHOD`](ACCOUNT_USAGE.LOGIN_HISTORY/AUTHENTICATION_METHOD.md) | Mechanism | One per event | `PASSWORD`, `SAML`, `OAUTH`, `KEYPAIR` |
...
| [`USER_NAME`](ACCOUNT_USAGE.ACCESS_HISTORY/USER_NAME.md) | Identity | One per query | |
| [`DIRECT_OBJECTS_ACCESSED`](ACCOUNT_USAGE.ACCESS_HISTORY/DIRECT_OBJECTS_ACCESSED.md) | Tables/views | One per query | JSON array of objects |
| [`BASE_OBJECTS_ACCESSED`](ACCOUNT_USAGE.ACCESS_HISTORY/BASE_OBJECTS_ACCESSED.md) | Underlying tables | One per query | JSON array for views |
| [`OBJECTS_MODIFIED`](ACCOUNT_USAGE.ACCESS_HISTORY/OBJECTS_MODIFIED.md) | DML targets | One per query | JSON array |
| [`COLUMNS_ACCESSED`](ACCOUNT_USAGE.ACCESS_HISTORY/COLUMNS_ACCESSED.md) | Column detail | One per query | JSON array of column references |
...
| [`CREDITS_USED`](ACCOUNT_USAGE.WAREHOUSE_METERING_HISTORY/CREDITS_USED.md) | Total cost | One per warehouse per interval | |
| [`CREDITS_USED_COMPUTE`](ACCOUNT_USAGE.WAREHOUSE_METERING_HISTORY/CREDITS_USED_COMPUTE.md) | Compute cost | One per warehouse per interval | |
...
|---|---|---|---|---|---|---|
| [`QUERY_TAG`](Parameters  Variables  Configuration/QUERY_TAG.md) | Session parameter | Audit traceability | String <= 256 chars | None | Session/query | Tags query history |
| [`TIMEZONE`](Parameters  Variables  Configuration/TIMEZONE.md) | Session parameter | Timestamp context | IANA timezone | `UTC` | Session | Affects audit timestamps |
| [`TIMESTAMP_OUTPUT_FORMAT`](Parameters  Variables  Configuration/TIMESTAMP_OUTPUT_FORMAT.md) | Session parameter | Display format | Format string | `YYYY-MM-DD HH24:MI:SS.FF3 TZHTZM` | Session | Affects result rendering |
| [`CLIENT_SESSION_KEEP_ALIVE`](Parameters  Variables  Configuration/CLIENT_SESSION_KEEP_ALIVE.md) | Session parameter | Session duration | `TRUE`, `FALSE` | `FALSE` | Session | Extends session for long audits |
| [`STATEMENT_TIMEOUT_IN_SECONDS`](Parameters  Variables  Configuration/STATEMENT_TIMEOUT_IN_SECONDS.md) | Session parameter | Query abort limit | Integer | `172800` | Session | Limits long audit queries |
| [`AUDIT_LOG`](Parameters  Variables  Configuration/AUDIT_LOG.md) | Account integration | External export | Integration configuration | None | Account | Exports audit events |
| [`DATA_RETENTION_TIME_IN_DAYS`](Parameters  Variables  Configuration/DATA_RETENTION_TIME_IN_DAYS.md) | Object parameter | Time travel retention | 0-90 (Enterprise+) | `1` | Table/schema/database | Determines historical data availability |
| [`MAX_DATA_EXTENSION_TIME_IN_DAYS`](Parameters  Variables  Configuration/MAX_DATA_EXTENSION_TIME_IN_DAYS.md) | Account parameter | Fail-safe retention | 0-90 | `0` | Account | Additional recovery period |
...
|---|---|---|
| [Query ACCOUNT_USAGE views](Privilege Requirements/Query ACCOUNT_USAGE views.md) | `MONITOR` or `ACCOUNTADMIN` | Account |
| [Query INFORMATION_SCHEMA](Privilege Requirements/Query INFORMATION_SCHEMA.md) | `USAGE` on database/schema | Database/Schema |
| [View ACCESS_HISTORY](Privilege Requirements/View ACCESS_HISTORY.md) | `MONITOR` or `ACCOUNTADMIN` | Account |
| [Configure audit log export](Privilege Requirements/Configure audit log export.md) | `ACCOUNTADMIN` | Account |
| [Set QUERY_TAG](Privilege Requirements/Set QUERY_TAG.md) | No special privilege | Session |
| [View own queries](Privilege Requirements/View own queries.md) | None | Self |
