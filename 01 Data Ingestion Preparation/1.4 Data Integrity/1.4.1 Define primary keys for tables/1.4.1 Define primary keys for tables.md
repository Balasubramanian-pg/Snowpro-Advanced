...
| :--- | :--- | :--- | :--- | :--- |
| [**`PRIMARY KEY`**](Feature Summary/PRIMARY KEY.md) | Table Constraint | Uniquely identify a row logically. | **Not enforced** (Allows duplicates) | Visible in `SHOW PRIMARY KEYS` and `GET_DDL()`. |
| [**`NOT NULL`**](Feature Summary/NOT NULL.md) | Column Constraint | Prevent missing values in the key. | **Strictly enforced** | DML fails if `NULL` is inserted. Automatically applied to PK columns. |
| [**`RELY`**](Feature Summary/RELY.md) | Constraint Property | Instructs the optimizer to trust the key for query rewrites. | Metadata directive | Optimizer eliminates unnecessary joins in the query plan. |
